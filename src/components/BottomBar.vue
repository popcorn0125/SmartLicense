<template>
    <div class="bottom_bar">
        ...
        <svg @click="goToRankingPage()" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
        ...
        <svg @click="goToMyPage" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="24" height="24" :fill="mysvg">
...
export default {
    ...
    methods: {
        ...
        goToRankingPage() {
            this.$router.push('/RankingPage'); // RankingPage 페이지로 이동
        },
        goToMyPage() {
