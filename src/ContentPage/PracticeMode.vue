<template>
    ...
    <div class="practive_mode_container">
      ...
      <div class="OX">
        ...
        <img src="@/assets/collectanswer.png" class="collectimg"
          :style="{ display: displayCorrectAnswer ? 'block' : 'none' }">
      </div>
      ...
      <div class="btn_collection">
        ...
        <button v-if="showCorrectAnswer && Qnumber <= 20" @click="showExplanation" class="explain_btn">해설보기</button>
